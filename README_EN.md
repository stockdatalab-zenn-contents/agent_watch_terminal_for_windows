...
| **Shift + drag**   | **Selects text. While an AI tool is running, dragging without Shift does not select.**<br>While Shift is held, mouse input is not forwarded to the AI tool and is treated as selection only. |
