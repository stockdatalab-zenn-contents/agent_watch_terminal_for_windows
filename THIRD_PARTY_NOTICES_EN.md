...
- External AI tools (Claude Code, Codex CLI, GitHub Copilot CLI, Bob Shell) used within this terminal are **not** covered by this project's license. Please refer to each tool's own terms of use.
